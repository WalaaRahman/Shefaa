...
export class ForgetPasswordComponent implements OnInit {
  ...
  constructor(private router:Router, private _formBuilder:FormBuilder, private httpClient:HttpClient,private _partnerService:PartnerService) { }
  ...
  sendCode(){
    ...
    this.httpClient.post('http://localhost:3000/partner/resetCode',this.email,{headers:{'authorization':this.token}}).subscribe((response)=>{

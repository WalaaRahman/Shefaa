...
export class ResetPasswordComponent implements OnInit {
  ...
  constructor(private _formBuilder: FormBuilder, private _partnerService:PartnerService, private _apiService: ApiService , private _router: Router) { }
  ...
  resetPassword() {
    ...
    this._apiService.put('partner/update', body).subscribe((response) => {
